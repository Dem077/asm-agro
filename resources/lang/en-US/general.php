...
return [
    ...
    'logout'				=> 'Logout',
    'lookup_by_tag'     => 'Lookup by Asset Identifier',
    ...
    'search'				=> 'Search',
    'select_category'       => 'Select a Asset Account',
    ...
    'auto_incrementing_asset_tags_disabled_so_tags_required' => 'Generating auto-incrementing Asset Identifiers is disabled so all rows need to have the "Asset Identifier" column populated.',
    'auto_incrementing_asset_tags_enabled_so_now_assets_will_be_created' => 'Note: Generating auto-incrementing Asset Identifiers is enabled so assets will be created for rows that do not have "Asset Identifier" populated. Rows that do have "Asset Identifier" populated will be updated with the provided information.',
    ...
    'importer' => [
        ...
        'checked_out_to_tag' => 'Checked Out to: Asset Identifierntifier',
    ...
    'label' => 'Label',
    'import_asset_tag_exists' => 'An asset with the Asset Identifier :asset_tag already exists and an update was not requested. No change was made.',
