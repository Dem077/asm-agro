...
return [
    ...
    'do_not_depreciate' => 'Do Not Depreciate',
    'depreciation_straight_line' => 'Straight Line',
    'depreciation_reducing_balance' => 'Reducing Balance',
    'depreciation_months' => 'Depreciation Months',
    'depreciation_percentage' => 'Annual Depreciation Rate',
    'depreciation_percentage_help' => 'Applied each month to the current net book value (NBV). Monthly depreciation = NBV × (annual rate ÷ 12).',
    'depreciation_straight_line_summary' => 'Straight line (:months months)',
    'depreciation_reducing_balance_summary' => 'Reducing balance (:percentage% per year)',
